...
export default function ProductDetails({route}) {
  ...
  const ProductDescription = () => {
    return (
      <View>
        <Text
          style={{color: '#fff', fontWeight: 500, fontSize: 20, marginTop: 20}}>
          {colorProduct.brandname} {colorProduct.productname}{' '}
          {colorProduct.modelno}
        </Text>
        ...
        <View style={{marginTop: 10}}>
          ...
          <View
            style={{marginTop: 4, borderBottomWidth: 1.5, borderColor: '#fff'}}
          />
          ...
          <View
            ...
            <RenderHtml
              tagsStyles={{
                body: {color: '#fff', fontSize: 15, fontWeight: 500},
              }}
              contentWidth={width}
